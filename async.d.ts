...
export type Algorithm = LiteralUnion<'sha1' | 'sha256' | 'sha384' | 'sha512', string>;
...
export type Options = {
	...
	*/
	...
	/**
	_Don't use `'sha1'` for anything sensitive. [It's insecure.](http://googleonlinesecurity.blogspot.no/2014/09/gradually-sunsetting-sha-1.html)_
